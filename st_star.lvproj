...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Type Definitions" Type="Folder">
			...
			<Item Name="st_str Analysis Configuration.ctl" Type="VI" URL="../controls/st_str Analysis Configuration.ctl"/>
			<Item Name="st_str Data.ctl" Type="VI" URL="../controls/st_str Data.ctl"/>
			<Item Name="st_str Graph Data.ctl" Type="VI" URL="../controls/st_str Graph Data.ctl"/>
			<Item Name="st_str HW Configuration.ctl" Type="VI" URL="../controls/st_str HW Configuration.ctl"/>
			<Item Name="st_str New Data Behavior.ctl" Type="VI" URL="../controls/st_str New Data Behavior.ctl"/>
			<Item Name="st_str Simulated Signal Type.ctl" Type="VI" URL="../controls/st_str Simulated Signal Type.ctl"/>
			<Item Name="st_str State.ctl" Type="VI" URL="../controls/st_str State.ctl"/>
			<Item Name="st_str UI References.ctl" Type="VI" URL="../controls/st_str UI References.ctl"/>
			<Item Name="st_str User Specified Data.ctl" Type="VI" URL="../controls/st_str User Specified Data.ctl"/>
		</Item>
		<Item Name="SubVIs" Type="Folder">
			<Property Name="NI.SortType" Type="Int">0</Property>
			<Item Name="Utility VIs" Type="Folder">
				<Property Name="NI.SortType" Type="Int">0</Property>
				<Item Name="st_str Analysis Configuration Dialog.vi" Type="VI" URL="../subVIs/st_str Analysis Configuration Dialog.vi"/>
				<Item Name="st_str Get Configuration File Path.vi" Type="VI" URL="../subVIs/st_str Get Configuration File Path.vi"/>
				<Item Name="st_str Get Scale Labels.vi" Type="VI" URL="../subVIs/st_str Get Scale Labels.vi"/>
				<Item Name="st_str Incorporate New Data.vi" Type="VI" URL="../subVIs/st_str Incorporate New Data.vi"/>
				<Item Name="st_str Load Configuration Settings from XML.vi" Type="VI" URL="../subVIs/st_str Load Configuration Settings from XML.vi"/>
				<Item Name="st_str Save Configuration Settings to XML.vi" Type="VI" URL="../subVIs/st_str Save Configuration Settings to XML.vi"/>
				<Item Name="st_str Set Enable State on Multiple Controls.vi" Type="VI" URL="../subVIs/st_str Set Enable State on Multiple Controls.vi"/>
			</Item>
			<Item Name="st_str Acquire Data from Hardware.vi" Type="VI" URL="../subVIs/st_str Acquire Data from Hardware.vi"/>
			<Item Name="st_str Copy Graph to Clipboard.vi" Type="VI" URL="../subVIs/st_str Copy Graph to Clipboard.vi"/>
			<Item Name="st_str Export Data.vi" Type="VI" URL="../subVIs/st_str Export Data.vi"/>
			<Item Name="st_str Load Data.vi" Type="VI" URL="../subVIs/st_str Load Data.vi"/>
			<Item Name="st_str Save Data.vi" Type="VI" URL="../subVIs/st_str Save Data.vi"/>
			<Item Name="st_str Settings Dialog.vi" Type="VI" URL="../subVIs/st_str Settings Dialog.vi"/>
			<Item Name="st_str Statistical Analysis.vi" Type="VI" URL="../subVIs/st_str Statistical Analysis.vi"/>
		</Item>
		<Item Name="st_str Main.vi" Type="VI" URL="../st_str Main.vi"/>
